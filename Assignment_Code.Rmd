...
#Formal modelling
Since we have 54 variables to evaluate on their predictive power we choose to work with a random forest which will sample both the observations and the variables and build different decision trees. 

<Leg nog beter uit, maar bekijk eerst terug de video en let ook op op cross validation>
```{r random forest}
